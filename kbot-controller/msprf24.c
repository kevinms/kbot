...
__attribute__((interrupt(USI_VECTOR))) void USI_TXRX(void)
{
...
__attribute__((interrupt(USCIAB0RX_VECTOR))) void USCI_RX(void)
{
...
__attribute__((interrupt(USCI_A0_VECTOR))) void USCI_A0(void)
{
	UCA0IE &= ~UCRXIE;
...
__attribute__((interrupt(USCI_B0_VECTOR))) void USCI_B0(void)
{
	UCB0IE &= ~UCRXIE;
	__bic_SR_register_on_exit(LPM0_bits);
}
...
__attribute__((interrupt(PORT2_VECTOR))) void P2_IRQ(void)
{
        if(P2IFG & nrfIRQpin){
